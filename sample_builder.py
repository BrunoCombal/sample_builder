...
class SampleBuilder:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SampleBuilder_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Sample Builder')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'SampleBuilder')
        self.toolbar.setObjectName(u'SampleBuilder')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SampleBuilder', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SampleBuilder/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Build sample plane'),
            callback=self.run,
